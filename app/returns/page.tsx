...
export default function ReturnsPage() {
  const { returns, projects, currentUser, addReturn, updateReturn, deleteReturn, updateReturnStatus } = useStore()
  ...
  return <div className="flex flex-1 flex-col gap-6 p-4 md:p-6">
    ...
    <ReturnsTable data={returns} projects={projects} onStatusChange={updateReturnStatus} onSave={updateReturn} onDelete={(id) => { deleteReturn(id); toast.success("Devolución eliminada") }} />
  </div>
}
